package com.pepsidrc.ui.invoice.adapter
...
) : ListAdapter<MoreItems, AdapteInvoice.ViewHolder>(
    AdapterMoreCallback()
)
{
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): AdapteInvoice.ViewHolder {
