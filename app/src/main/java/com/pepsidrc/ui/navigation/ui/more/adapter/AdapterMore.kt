package com.pepsidrc.ui.navigation.ui.more.adapter
...
) : ListAdapter<MoreItems, AdapterMore.ViewHolder>(
    AdapterMoreCallback()
)
{
    override fun onCreateViewHolder(parent: ViewGroup, p1: Int): AdapterMore.ViewHolder {
