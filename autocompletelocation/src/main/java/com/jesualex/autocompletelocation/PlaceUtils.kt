...
object PlaceUtils {
    val defaultFields: List<Place.Field>
        get() = listOf(Place.Field.ID, Place.Field.NAME, Place.Field.ADDRESS,Place.Field.LAT_LNG)
...
//                below code is added by vijayaraj.s
                    Log.e(AutocompleteLocation::class.java.simpleName, "getting Error")
                }
    }
}
